...
const projects = [
    ...
    {
        title: "HxTrainingClub",
        category: "Elite Lifestyle Training",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div>
                        ...
                        <h3 className="text-3xl md:text-5xl font-bold text-white font-oswald uppercase tracking-tight">Results Speak <span className="text-blood-red drop-shadow-[0_0_10px_rgba(138,3,3,0.5)]">4</span> <span className="text-gray-600">Themselves</span></h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => {
                        ...
                        return (
                            <Wrapper key={index} {...linkProps} className={`group relative aspect-[4/5] overflow-hidden rounded-sm bg-neutral-900 block ${project.url ? 'cursor-pointer' : ''}`}>
                                <img
                                    src={project.image}
                                    alt={project.title}
