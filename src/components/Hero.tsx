    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-transparent overflow-hidden">
            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto flex flex-col items-center">
                ...
                <h1 className="font-oswald tracking-wider leading-none mb-6 animate-fade-in-up delay-200 select-none">
                ...
                <div className="mt-16 animate-fade-in-up delay-400">
                    <button
                        ...
                        className="text-white/60 hover:text-blood-red transition-all duration-500 font-oswald uppercase tracking-[0.3em] text-xs border-b border-white/10 hover:border-blood-red/50 pb-2 hover:shadow-[0_0_20px_rgba(138,3,3,0.4)]"
                    >
                        Get Started
                    </button>
                </div>
